        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <input
              ...
              style={{ background: '#0d0d0a', border: '1px solid #3a3a30', borderRadius: '8px', padding: '0.85rem 1rem', color: '#f5f5f0', fontSize: '0.875rem', outline: 'none', fontFamily: 'inherit', width: '100%', boxSizing: 'border-box' }}
            />
            <input
              type="password"
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              style={{ background: loading ? '#a06b00' : '#f59e0b', color: '#0d0d0a', border: 'none', borderRadius: '8px', padding: '0.9rem', fontSize: '0.9rem', fontWeight: 700, cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'inherit', marginTop: '0.25rem', width: '100%' }}
            >
